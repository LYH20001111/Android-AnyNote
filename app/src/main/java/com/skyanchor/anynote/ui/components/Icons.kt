...
object AppIcons {
    ...
    /** 回收站恢复用：环形回旋箭头，不带 Restore/History 的表盘指针，避免与历史页图标混淆。 */
    val RestoreLoop = icon(
        "restore_loop",
    ...
    val VolumeUp = icon(
        "volume_up",
        "M3,9v6h4l5,5L12,4L7,9L3,9zM16.5,12c0,-1.77 -1.02,-3.29 -2.5,-4.03v8.05c1.48,-0.73 2.5,-2.25 2.5,-4.02zM14,3.23v2.06c2.89,0.86 5,3.54 5,6.71s-2.11,5.85 -5,6.71v2.06c4.01,-0.91 7,-4.49 7,-8.77s-2.99,-7.86 -7,-8.77z",
    )
    /** 便签卡片：顶部色带 + 两行文字，配合角标红点表达「常驻通知承载待处理数量」。 */
    val NoteCard = icon(
        "note_card",
        "M5,4H19C20.1,4 21,4.9 21,6V18C21,19.1 20.1,20 19,20H5C3.9,20 3,19.1 3,18V6C3,4.9 3.9,4 5,4Z" +
            "M4.6,6.2V17.8C4.6,18.13 4.87,18.4 5.2,18.4H18.8C19.13,18.4 19.4,18.13 19.4,17.8V6.2" +
            "C19.4,5.87 19.13,5.6 18.8,5.6H5.2C4.87,5.6 4.6,5.87 4.6,6.2Z" +
            "M4.6,5.6H19.4V9.2H4.6ZM7,11.8H17V13.2H7ZM7,15H14.5V16.4H7Z",
    )
    /** 手机轮廓内嵌挂锁：表达「锁屏显示正文」。 */
    val PhoneLock = icon(
        "phone_lock",
        "M17,1.01L7,1c-1.1,0 -2,0.9 -2,2v18c0,1.1 0.9,2 2,2h10c1.1,0 2,-0.9 2,-2v-18c0,-1.09 -0.9,-1.99 -2,-1.99z" +
            "M17,19L7,19L7,5h10v14z" +
            "M10.2,11.6V10.2C10.2,7.6 13.8,7.6 13.8,10.2V11.6H12.5V10.2C12.5,8.9 11.5,8.9 11.5,10.2V11.6Z" +
            "M10,11.4H14C14.44,11.4 14.8,11.76 14.8,12.2V15.6C14.8,16.04 14.44,16.4 14,16.4H10" +
            "C9.56,16.4 9.2,16.04 9.2,15.6V12.2C9.2,11.76 9.56,11.4 10,11.4Z" +
            "M12.75,13.7C12.75,13.29 12.41,12.95 12,12.95C11.59,12.95 11.25,13.29 11.25,13.7" +
            "C11.25,14.11 11.59,14.45 12,14.45C12.41,14.45 12.75,14.11 12.75,13.7Z",
    )
}
